...
import edu.huflit.appphongtro.HoaDon.EditHD;
...
public class EditPhong extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnback_edit = findViewById(R.id.btnBack_editPhong);

        btnback_edit.setOnClickListener(new View.OnClickListener() {
            @Override
